    ...
    return (
        <div style={{display: isCompletedLoading ? "flex" : "none"}} className="console-screen-wrapper">
            ...
            <div className="console-screen">
                <Image className="console-screen__corner console-screen__corner--left" src={cornerLeftImg} width={147} height={122} alt={"Corner"} onLoadingComplete={handleItemLoading} />
                <Image className="console-screen__corner console-screen__corner--up-right" src={cornerUpRight} width={95} height={125} alt={"Corner"} onLoadingComplete={handleItemLoading} />
                <Image className="console-screen__corner console-screen__corner--down-right" src={cornerDownRightImg} width={172} height={112} alt={"Corner"} onLoadingComplete={handleItemLoading} />
